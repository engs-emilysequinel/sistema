...
O aplicativo busca se tornar um facilitador, reunindo todas as ferramentas necessárias para uma sessão de RPG em um app, assim melhorando a organização.
...
- Visualizador de mapa/combate (grid 2D)  
- Sistema de convites para jogadores  
- Bestiário  
- Escudo do mestre (GM Screen)  
- Dicas de combinação (raça, classe, antecedente)  
- Abas organizadas por raça e classe  
